...
static uint8_t neon_parser_build_message(uint8_t* pay, uint16_t paylen, uint8_t type,
                                         uint8_t* msg_out);
/**=================================================================================================
 **                                      Private Functions
 **===============================================================================================*/
...
uint8_t neon_message_handler(neon_parser_t* pParser, uint8_t tx, uint8_t type, uint8_t* payload,
                             uint8_t* output)
{
